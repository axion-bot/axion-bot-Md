...
// --- LOGICA DI CONTROLLO MESSAGGI (Si attiva ad ogni messaggio) ---
export async function before(m, { conn, isAdmin, isBotAdmin }) {
    ...
    // Se l'utente è mutato, il bot è admin e chi scrive NON è admin
