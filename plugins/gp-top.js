let handler = async (m, { conn, command, usedPrefix }) => {
  ...
  if (command === 'resettp') {
    ...
    return m.reply("🔄 *𝐋𝐚 𝐜𝐥𝐚𝐬𝐬𝐢𝐟𝐢𝐜𝐚 𝐝𝐢 𝐪𝐮𝐞𝐬𝐭𝐨 𝐠𝐫𝐮𝐩𝐩𝐨 è 𝐬𝐭𝐚𝐭𝐚 𝐫𝐞𝐬𝐞𝐭𝐭𝐚𝐭𝐚*")
  }
...
>>>>>>> b5faefb (update)
  ...
  testo += `──────────────────\n`
  testo += isAll ? ` 𝐂𝐥𝐚𝐬𝐬𝐢𝐟𝐢𝐜𝐚 𝐬𝐭𝐨𝐫𝐢𝐜𝐚` : `⏳ 𝐑𝐞𝐬𝐞𝐭 𝐨𝐠𝐧𝐢 𝐠𝐢𝐨𝐫𝐧𝐨`
  ...
  if (isAll) {
    if (limite === 3) {
      ...
      buttons.push({ buttonId: `${usedPrefix}topall`, buttonText: { displayText: '🔙 TopAll 3' }, type: 1 })
    }
  } else {
    if (limite === 3) {
      buttons.push(
      ...
      buttons.push({ buttonId: `${usedPrefix}top`, buttonText: { displayText: '🔙 Top 3' }, type: 1 })
    }
  }
  ...
  await conn.sendMessage(m.chat, {
    text: testo,
    mentions: menzioni,
    footer: isAll ? '𝐂𝐚𝐦𝐛𝐢𝐚 𝐥𝐚 𝐜𝐥𝐚𝐬𝐬𝐢𝐟𝐢𝐜𝐚 𝐭𝐨𝐭𝐚𝐥𝐞' : '𝐂𝐚𝐦𝐛𝐢𝐚 𝐥𝐚 𝐜𝐥𝐚𝐬𝐬𝐢𝐟𝐢𝐜𝐚 𝐠𝐢𝐨𝐫𝐧𝐚𝐥𝐢𝐞𝐫𝐚',
    buttons,
    headerType: 1
  }, { quoted: m })
}
...
handler.before = async function (m) {
  ...
  if (!chat.archivioMessaggi || chat.archivioMessaggi.ultimoReset !== oggi) {
    chat.archivioMessaggi = { totali: 0, utenti: {}, ultimoReset: oggi }
  }
