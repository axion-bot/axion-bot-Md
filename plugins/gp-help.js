...
let handler = async (m, { conn, text, command }) => {
  ...
  const supportGroup = global.StaffChat || global.botErrorChat || '120363405786547241@g.us'
...
*╰━━━━━━━━━━━━━━━━⬣*`
  ...
  await m.reply('*✅ 𝐑𝐢𝐜𝐡𝐢𝐞𝐬𝐭𝐚 𝐢𝐧𝐯𝐢𝐚𝐭𝐚 𝐚𝐥𝐥𝐨 𝐬𝐭𝐚𝐟𝐟*')
}
...
handler.before = async function (m) {
  ...
  if (pendingReasons.has(m.sender)) {
    ...
    const reason = m.text.trim() || '𝐍𝐞𝐬𝐬𝐮𝐧𝐚 𝐦𝐨𝐭𝐢𝐯𝐚𝐳𝐢𝐨𝐧𝐞'
...
*╰━━━━━━━━━━━━━━━━⬣*`,
    ...
    await this.sendMessage(data.chat, {
      text: `*✅ 𝐋𝐚 𝐭𝐮𝐚 𝐫𝐢𝐜𝐡𝐢𝐞𝐬𝐭𝐚 è 𝐬𝐭𝐚𝐭𝐚 𝐫𝐢𝐬𝐨𝐥𝐭𝐚*
*👤 𝐔𝐭𝐞𝐧𝐭𝐞:* @${bare(data.requester)}
*📝 𝐌𝐨𝐭𝐢𝐯𝐨:* ${reason}`,
