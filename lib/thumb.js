...
const thumbs = {
  ...
  warn: path.resolve('./media/warn.png'),
  kick: path.resolve('./media/kick.png'),
  aperto: path.resolve('./media/aperto.png'),
  chiuso: path.resolve('./media/chiuso.png'),
  warnings: path.resolve('./media/warn.png'),
  ...
  antiviewonce: path.resolve('./media/funzioni/antivo.png'),
  antidelete: path.resolve('./media/funzioni/antidelete.png'),
  ...
  antiwz: path.resolve('./media/funzioni/antilink.png'),
  ...
  antinuke: path.resolve('./media/funzioni/antinuke.png'),
  ia: path.resolve('./media/funzioni/ia.png'),
  autodb: path.resolve('./media/funzioni/autodb.png'),
